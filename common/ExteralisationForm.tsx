...
const schema = Yup.object().shape({
  resourceExt: Yup.array().min(
    1,
    "Veuillez sélectionner au moins une ressource"
  ),
  ...
  durationExt: Yup.array().min(1, "Veuillez préciser la durée"),

  timeExt: Yup.array().min(
    1,
  ...
  otherTimeExt: Yup.string().when("timeExt", {
    is: (val: string[]) => val?.includes("autre"),
    then: (schema) =>
      schema.required("Veuillez préciser l'autre créneau horaire"),
  }),

  competenciesExt: Yup.string().required("Veuillez indiquer la compétence"),

  experiencesExt: Yup.array().min(
    1,
    "Veuillez sélectionner au moins une expérience"
  ),

  languageExt: Yup.array().min(1, "Veuillez sélectionner au moins une langue"),
  ...
  modalityExt: Yup.array().min(1, "Veuillez indiquer le suivi souhaité"),

  facturationModExt: Yup.array().min(
    1,
    "Veuillez indiquer le mode de facturation"
  ),
});
          ...
          <div className="flex flex-col gap-8 bg-white text-gray-700 p-6 md:p-10 w-4xl rounded-lg shadow-2xl">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2 pl-4">
                  <p>Date de début</p>
                  <Field type="date" name="dateStartExt" />
                  <ErrorMessage
                    name="dateStartExt"
                    component="div"
                    className="error-message"
