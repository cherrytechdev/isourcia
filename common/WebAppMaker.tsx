...
const schema = Yup.object().shape({
  webObj: Yup.array().min(
    1,
    "Veuillez sélectionner au moins un objectif pour le site web"
  ),
  ...
  webDesign: Yup.array().min(
    1,
    "Veuillez sélectionner au moins un style de design web"
  ),

  webContent: Yup.array().min(
    1,
