                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center">
                  ...
                  >
                    ...
                    <div className={`rounded-md bg-blue-500 w-fit flex gap-2 mb-2 ${activeForm === "night" ? "border border-white" : ""}`}>
                      ...
                      <button
                        type="button"
                        className={`cursor-pointer transition-all ${activeForm === "night" ? "shadow-lg rounded-r-md rounded-l-0 bg-[#040A18] p-2 font-bold text-white" : "text-white px-2"}`}
                      ...
                      {TimeTravelInf.map((item, i) => {
                        ...
                        return (
                          <div key={i} className="flex flex-col items-center gap-2">
                            <label htmlFor={`${activeForm}-${normalizedKey}`} className="text-sm">
                              {item}
                            </label>
                            <input
                              type="text"
                    ...
                    <button
                      ...
                      onClick={() => {
                        ...
                        // const result = [dayTimes, nightTimes].filter(Boolean).join(" (JOUR) | (NUIT) ");
                        const result = `Jour: ${dayTimes}, Nuit: ${nightTimes}`;
