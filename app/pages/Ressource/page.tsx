    ...
    return(
        <section className="bg-white py-10 lg:py-0">
            <Container className="flex flex-col items-center gap-2 justify-center lg:h-screen">
                ...
                <Link 
                    href="/"
                    className="hidden md:block border border-[#0A1027] p-2 rounded-full transition-all hover:border hover:border-[#0A1027] hover:bg-white/10 hover:backdrop-blur-2xl">
                    <svg 
                        xmlns="http://www.w3.org/2000/svg" 
                        width="40" 
                        height="40" 
