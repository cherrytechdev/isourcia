...
export default function FeatureTable({ title, features }: FeatureTableProps) {
  ...
  return (
    <div className="mb-16">
      <h2 className="text-xl md:text-3xl font-bold mb-8 text-gray-800">{title}</h2>
      ...
      <div className="bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        {features.map((f, i) => (
          <div key={i} className="grid grid-cols-1 md:grid-cols-4 gap-4 p-4 border-b border-gray-200 hover:bg-gray-50 group">
            ...
            <div className="flex md:justify-center items-center">
              ...
              <div className={`px-3 py-1 rounded-full text-sm font-medium ${f.initial === '✓' ? 'bg-green-100 text-green-800' :
            ...
            <div className="flex md:justify-center items-center">
              ...
              <div className={`px-3 py-1 rounded-full text-sm font-medium ${f.evolution === 'Simple' ? 'bg-yellow-100 text-yellow-800' :
                  f.evolution === 'Etendue' ? 'bg-purple-100 text-purple-800' :
