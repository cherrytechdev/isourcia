  ...
  return (
    <div>
      ...
      <div className="bg-[#D9D9D9] ">
        <Container className="min-h-screen grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10 text-black">
          ...
          <div className="flex flex-col gap-8">
            <div>
              <h2 className="font-medium text-4xl md:text-5xl lg:text-6xl text-black ">
            ...
            <p>
              ...
              l’esthétique se marie à la performance, et chaque idée devient une
              histoire qui résonne avec votre public <br /> De la création
              visuelle à l’accompagnement stratégique, en passant par des
              solutions digitales innovantes et des services centrés sur
              l’expérience client, nous vous offrons un accompagnement sur
              mesure et une qualité de service unique.
            </p>
          </div>
        </Container>
      </div>
